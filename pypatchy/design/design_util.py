...
def all_overlap_rotation(ct1: PolycubeRuleCubeType, ct2: PolycubeRuleCubeType) -> Union[bool, np.ndarray]:
    """
    iters all possible rotations of cube type 1 onto cube type 2 without overlaying patches
    :param ct1: cube type 1
    :param ct2: cube type 2
    :return: either False or a list of rotation matrices that overlay ct1 onto ct2 without patch overlaps
    """
