...
It is forked from this [repository](https://github.com/Akodiat/polycubes/tree/master/cpp). It is used to stochastic lattice simulation in cases where the Javascript-based web app is too slow.
